...
namespace Vidly.Migrations
{
    ...
    [Migration("20230126071620_addingForeignKeyAsMembershipType")]
    partial class addingForeignKeyAsMembershipType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vidly.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2157),
                            Genre = "Romance",
                        ...
                        {
                            Id = 2,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2187),
                            Genre = "Adventure",
                            Name = "Jumanji",
                        ...
                        {
                            Id = 3,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2196),
                            Genre = "Mistery",
                        ...
                        {
                            Id = 4,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2205),
                            Genre = "Romance",
                            Name = "Brown Coffee",
                            Release = new DateTime(2013, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Stock = 6
                        ...
                        {
                            Id = 5,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2215),
                            Genre = "Thriller",
                            Name = "Most Wanted",
                            Release = new DateTime(2016, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Stock = 18
                        ...
                        {
                            Id = 6,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2224),
                            Genre = "Thriller",
                        ...
                        {
                            Id = 7,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2234),
                            Genre = "Scify",
                            Name = "Blade Runner",
                        ...
                        {
                            Id = 8,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2243),
                            Genre = "Action",
                        ...
                        {
                            Id = 9,
                            Added = new DateTime(2023, 1, 26, 9, 16, 20, 112, DateTimeKind.Local).AddTicks(2252),
                            Genre = "Action",
