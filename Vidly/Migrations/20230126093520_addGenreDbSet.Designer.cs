...
namespace Vidly.Migrations
{
    ...
    [Migration("20230126093520_addGenreDbSet")]
            ...
            modelBuilder.Entity("Vidly.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4295),
                            Genre = "Romance",
                        ...
                        {
                            Id = 2,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4337),
                            Genre = "Adventure",
                            Name = "Jumanji",
                        ...
                        {
                            Id = 3,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4352),
                            Genre = "Mistery",
                        ...
                        {
                            Id = 4,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4367),
                            Genre = "Romance",
                            Name = "Brown Coffee",
                            Release = new DateTime(2013, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Stock = 6
                        ...
                        {
                            Id = 5,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4382),
                            Genre = "Thriller",
                            Name = "Most Wanted",
                            Release = new DateTime(2016, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Stock = 18
                        ...
                        {
                            Id = 6,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4397),
                            Genre = "Thriller",
                        ...
                        {
                            Id = 7,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4412),
                            Genre = "Scify",
                            Name = "Blade Runner",
                        ...
                        {
                            Id = 8,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4427),
                            Genre = "Action",
                        ...
                        {
                            Id = 9,
                            Added = new DateTime(2023, 1, 26, 11, 35, 19, 785, DateTimeKind.Local).AddTicks(4441),
                            Genre = "Action",
