...
namespace Vidly.Migrations
{
    ...
    [Migration("20230126101426_seedingGenreTable")]
    partial class seedingGenreTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vidly.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8755),
                        ...
                        {
                            Id = 2,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8786),
                            Name = "Jumanji",
                        ...
                        {
                            Id = 3,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8796),
                        ...
                        {
                            Id = 4,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8806),
                            Name = "Brown Coffee",
                            Release = new DateTime(2013, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Stock = 6
                        },
                        ...
                        {
                            Id = 5,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8816),
                            Name = "Most Wanted",
                            Release = new DateTime(2016, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Stock = 18
                        },
                        ...
                        {
                            Id = 6,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8826),
                        ...
                        {
                            Id = 7,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8835),
                            Name = "Blade Runner",
                        ...
                        {
                            Id = 8,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8845),
                        ...
                        {
                            Id = 9,
                            Added = new DateTime(2023, 1, 26, 12, 14, 26, 360, DateTimeKind.Local).AddTicks(8853),
